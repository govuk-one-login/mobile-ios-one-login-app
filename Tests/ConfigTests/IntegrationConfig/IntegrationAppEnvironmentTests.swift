...
final class IntegrationAppEnvironmentTests: XCTestCase {
    func test_defaultEnvironment_retrieveFromPlist() throws {
        ...
        XCTAssertEqual(sut.accessibilityStatementURL.absoluteString, "https://signin.integration.account.gov.uk/accessibility-statement?lng=en")
