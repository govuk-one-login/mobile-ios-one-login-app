...
struct EncryptedSecureStoreManagerTests {
    ...
    func checkItemExistsInV12() throws {
        try mockV12EncryptedSecureStore.saveItemV2(
            item: "testV12Item",
    ...
    func checkItemExistsInV13() throws {
        try mockV13EncryptedSecureStore.saveItemV2(
            item: "testV13Item",
            itemName: OLString.persistentSessionID
        )
        #expect(sut.checkItemExists(itemName: OLString.persistentSessionID))
    ...
    func readItemV12MigratesToV13() throws {
        ...
        let item = try sut.readItemV2(itemName: OLString.persistentSessionID)
    ...
    func readItemV12LogsCrash() throws {
        ...
        _ = try sut.readItemV2(itemName: OLString.persistentSessionID)
